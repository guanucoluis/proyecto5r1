...
\begin{figure}[H]
  \begin{subfigure}[b]{0.33\textwidth}
    ...
    \subcaption{Muestra 1}\label{fig:line-per-1}
  \end{subfigure}
%  \hfill
  \begin{subfigure}[b]{0.33\textwidth}
    \centering
    \includegraphics[width=\textwidth]{images/line_periodo_2}
    \subcaption{Muestra 2}\label{fig:line-per-2}
  \end{subfigure}
%  \hfill
  \begin{subfigure}[b]{0.33\textwidth}
    \centering
    \includegraphics[width=\textwidth]{images/line_periodo_3}
    \subcaption{Muestra 3}\label{fig:line-per-3}
  \end{subfigure}
%  \hfill
...
\begin{figure}[H]
  \begin{subfigure}[b]{0.33\textwidth}
    ...
    \subcaption{Muestra 1}\label{fig:out-per-1}
  \end{subfigure}
%  \hfill
  \begin{subfigure}[b]{0.33\textwidth}
    \centering
    \includegraphics[width=\textwidth]{images/out_periodo_2}
    \subcaption{Muestra 2}\label{fig:out-per-2}
  \end{subfigure}
%  \hfill
  \begin{subfigure}[b]{0.33\textwidth}
    \centering
    \includegraphics[width=\textwidth]{images/out_periodo_3}
    \subcaption{Muestra 3}\label{fig:out-per-3}
  \end{subfigure}
%  \hfill
