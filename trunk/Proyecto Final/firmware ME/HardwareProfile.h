...
// Sample clock speed for PIC18
    ...
    #define GetSystemClock()        10000000	//40000000                        // System clock frequency (Hz)
...
/* SD Card definitions: Change these to fit your application when using
   an SD-card-based physical layer                                   */
        ...
        #define SD_CD               PORTDbits.RD3
        // Description: SD-SPI Card Detect TRIS bit
        #define SD_CD_TRIS          TRISDbits.TRISD3
...
*/
        ...
        // Description: SD-SPI Card Detect Input bit
        #define SD_CD               PORTCbits.RC13
        // Description: SD-SPI Card Detect TRIS bit
        #define SD_CD_TRIS          TRISCbits.TRISC13
        
        // Description: SD-SPI Write Protect Check Input bit
        #define SD_WE               PORTCbits.RC14
        // Description: SD-SPI Write Protect Check TRIS bit
        #define SD_WE_TRIS          TRISCbits.TRISC14
