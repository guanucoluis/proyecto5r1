...
// Usar el timer 2 para la spi? (1 ó 0)
#define USAR_TIMER2_SPI 1
	...
	// Description: This macro is used to initialize a PIC18 SPI module with the TIMER 2.
	#define   SYNC_MODE_TIMER2  0x03
